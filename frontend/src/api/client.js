...
export const endpoints = {
    ...
    // Pipeline
    pipelineStatus: (runId) => `/pipeline/${runId}/status`,
    // Clusters
    clusters: (runId) => `/clusters?run_id=${runId}`,
    // Model
    modelMetricsSummary: (runId) => `/model/metrics/${runId}/summary`,
    modelMetricsFull: (runId) => `/model/metrics/${runId}`,
    confusionMatrix: (runId) => `/model/metrics/${runId}/confusion-matrix`,
    featureImportances: (runId) => `/model/metrics/${runId}/feature-importances`,
    // Incidents
    incidents: (params) => {
